...
public class StylistAdapter extends ArrayAdapter<String>{
    ...
    public StylistAdapter(Activity context, String[] img, String[] name ) {
        super(context, R.layout.listview_stylist, name);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.listview_stylist, null, true);
